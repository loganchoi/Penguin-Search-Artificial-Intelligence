...
'''
class State:
    def __init__(self, pengu=[],total=0, fishes=[],score = 0,moveStr = ""):
        self.pengu = pengu
        self.total = total
        self.fishes = fishes
        self.score = score
    ...
    It just takes the length of the moveStr as the cost.
    '''
    def cost(self):
        return len(self.moveStr)

    '''
    my A* just combines the heuristic and cost
    '''
    def aStar(self):
